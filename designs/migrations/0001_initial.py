    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('digital_product', models.FileField(null=True, upload_to='digital_products/')),
                ('price', models.DecimalField(decimal_places=2, help_text='Customer will download this file upon succesfull payment', max_digits=12, null=True)),
        ...
        migrations.AddField(
            model_name='design',
            name='categories',
            field=models.ManyToManyField(null=True, related_name='designs_categories', to='designs.Design_Category'),
        ),
