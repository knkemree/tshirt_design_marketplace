# Generated by Django 3.1.5 on 2021-03-01 21:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('category', models.ManyToManyField(blank=True, null=True, related_name='products', to='essentials.Category')),
                ('tags', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags')),
            ],
            options={
                'unique_together': {('slug', 'title')},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('color', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='essentials.color')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='variants', to='essentials.product')),
                ('size', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='essentials.size')),
            ],
            options={
                'ordering': ['size', 'color'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height', models.CharField(blank=True, default='300px', max_length=10, null=True)),
                ('top', models.CharField(blank=True, default='75px', max_length=10, null=True)),
                ('left', models.CharField(blank=True, default='150px', max_length=10, null=True)),
                ('placement', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='placements', to='essentials.placementbase')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('technique', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='essentials.techniquebase')),
            ],
            options={
                'ordering': ['row_no'],
            },
