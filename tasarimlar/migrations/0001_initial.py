# Generated by Django 3.1.3 on 2021-02-22 21:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('design', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='design_images', to='tasarimlar.design')),
            ],
            options={
                'ordering': ['row_no'],
            },
        ...
        migrations.AddField(
            model_name='design',
            name='categories',
            field=models.ManyToManyField(null=True, related_name='design_categories', to='tasarimlar.Design_Category'),
        ),
